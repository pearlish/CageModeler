...
{
	std::string obj = "botijo";
	std::string path_base = "C:/Users/jinjo/Documents/TUD/a2024wise/VC_lab/CageModeler/models/";
	std::string input_path = path_base + obj + ".obj";


	// generate voxel grid and mipmap
	MIPMAP_TYPE mipmap = voxelize_and_mipmap(input_path);
	...
	ExactMesh extracted_surface = extract_surface_from_voxels(e_grid, voxel_strides, global_min_point, obj);

	std::string intermediate_path = path_base + "mipmap_data/resol128/" + obj + "_interm.off";
	...
	std::string output_path = path_base + "mipmap_data/resol128/" + obj + "_cage.obj";
